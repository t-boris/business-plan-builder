...
Plans:
- [ ] 01-01: Project scaffolding (Vite + React + TS + Firebase), Firestore config, deploy pipeline
- [ ] 01-02: Dashboard layout (sidebar nav, header, content area), routing for all 9 sections
